            ...
            <div class="card">
                <div class="card-header">
                    <div class="btn-group" role="group" aria-label="Basic example" id="">
                        <a href="{{ route('nuevaFactura') }}" class="btn btn-dark">
        ...
        function selecionarProducto(arg){
            ...
            if($('#fila_'+id_pro).length){
                ...
                if($('.v_total_fila').length<=9){
                    ...
                    var caja_descuento='<input type="hidden" value="0" name="descuento['+id_pro+']" id="txt_valor_descuento_'+id_pro+'" class="txt_valor_descuento" /><input type="number" name="descuento['+id_pro+']" onkeyup="cambiarCantidad(this);" data-id="'+id_pro+'" id="txt_descuento_'+id_pro+'" value="0" class="form-control form-control-sm">';
